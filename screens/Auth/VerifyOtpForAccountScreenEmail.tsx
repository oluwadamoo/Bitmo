...
export default function VerifyOtpForAccountScreenEmail({
  route,
}: RootStackScreenProps<"Verify Otp Sent To Email">) {
          ...
          Alert.alert("Success!", response.data.message, [
            {
              text: "Alright Thanks",
              onPress: () =>
                navigation.navigate("Verify Otp Sent To Phone", {
      ...
      <View style={[styles.wrapper, { marginTop: -10 }]}>
        ...
        <View style={styles.authForm}>
          ...
          {isLoading ? (
            ...
            >
              <Text style={{ color: "#fff", fontSize: 19 }}>VERIFY OTP</Text>
            </Pressable>
          )}
        </View>
      </View>
