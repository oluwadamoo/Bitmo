...
export default function VerifyOtpForPasswordScreen({
  route,
}: RootStackScreenProps<"Verify Otp For Password Recovery">) {
    ...
    try {
      if (client_email && !isError) {
        ...
        const response = await axios.post(
          "http://backend.bitmoservice.com/api/resources/v1/client/verify-otp-for-fpw",
          { client_email, otp },
          { headers: headers }
        );
      ...
      <View style={[styles.wrapper, { marginTop: -10 }]}>
        ...
        <View style={styles.authForm}>
          ...
          {isLoading ? (
            ...
            >
              <Text style={{ color: "#fff", fontSize: 19 }}>Verify</Text>
            </Pressable>
          )}
